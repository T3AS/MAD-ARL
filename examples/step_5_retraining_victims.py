...
parser.add_argument(
    "--checkpoint-path",
    default='/home/aizaz/ray_results/MA-Inde-PPO-SSUI3CCARLA/PPO_HomoNcomIndePOIntrxMASS3CTWN3-v0_0_2021-06-07_15-30-2357l6q61m/checkpoint_350/checkpoint-350',
...
parser.add_argument(
    "--debug", action="store_true", help="Run in debug-friendly mode", default=True)
parser.add_argument(
    "--redis-address",
    default=None,
...
if args.debug:
    # For checkpoint loading and retraining
    ...
    # this part is not used in the current script.
    experiment_spec = tune.Experiment(
        "multi-carla/" + args.model_arch,
        "PPO",
        stop={"timesteps_since_restore": args.num_steps},
