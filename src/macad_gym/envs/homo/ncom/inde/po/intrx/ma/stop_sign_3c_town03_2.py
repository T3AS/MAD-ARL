...
class StopSign3CarTown03_2(MultiCarlaEnv):
    ...
    def __init__(self):
        self.configs = {
            ...
            "env": {
                ...
                "enable_planner": True,
                "spectator_loc": [170.5, 70, 50], #[140, 68, 9],
                "sync_server": True,
        ...
        super(StopSign3CarTown03_2, self).__init__(self.configs)


if __name__ == "__main__":
    env = StopSign3CarTown03_2()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
